        ...
        with tabs[1]:
            ...
            if forecast is not None and not future_forecast.empty:
                ...
                holidays_df = pd.DataFrame([
                    {"Дата": "28.06.2026", "Событие": "День Конституції України", "Вплив на продажі": "Короткочасний спад B2B-активності, зростання в HoReCa та дозвіллі"},
                    {"Дата": "15.07.2026", "Подія":  "День Державності України",  "Вплив на продажі": "Нейтральний ефект, стандартний літній торговий день"},
                    {"Дата": "24.08.2026", "Подія":  "День Незалежності 🇺🇦",      "Вплив на продажі": "Сплеск патріотичного попиту +15-25%, мерч, подарунки"},
                    {"Дата": "01.10.2026", "Подія":  "День захисників та захисниць","Вплив на продажі": "Високий попит на подарунки, спеціалізований асортимент"},
                    {"Дата": "19.12.2026", "Подія":  "Передноворічний пік",         "Вплив на продажі": "Сезонний максимум — готувати запаси заздалегідь"},
                ])
                # rename back to Russian headers for display
                holidays_df.columns = ["Дата", "Событие", "Влияние на продажи"]
